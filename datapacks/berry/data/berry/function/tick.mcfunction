...
execute if score $status berry matches ..0 as @a[tag=berry.in_game] run function berry:game/leave
execute if score $status berry matches ..0 as @a[tag=berry.spectator] run function berry:game/leave
